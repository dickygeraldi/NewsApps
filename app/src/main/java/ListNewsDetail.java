...
public class ListNewsDetail{
    ...
    public ListNewsDetail(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    }
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        viewAdapter holder = null;
        if (convertView == null) {
            holder = new viewAdapter();
            convertView = LayoutInflater.from(activity).inflate(
                    R.layout.fragment_fragment__au, parent, false);
            ...
            holder = (viewAdapter) convertView.getTag();
        }
        ...
        try{
            ...
            holder.title.setText(song.get(MainActivity.KEY_TITTLE));
